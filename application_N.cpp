...
void cl_application::bild_tree_objects()
{
	...
	p_ob_3 = new cl_3();
	p_ob_3->set_object_name("ob_1");
	p_ob_3->set_parent(this);
	
	p_ob_4 = new cl_4();
	p_ob_4->set_object_name("ob_2");
	p_ob_4->set_parent(p_ob_3);
	
	cl_4 * p_ob_41;
	p_ob_41 = new cl_4();
	p_ob_41->set_object_name("ob_3");
	p_ob_41->set_parent(p_ob_4);
	
	p_ob_1 = new cl_1;
	p_ob_1->set_object_name("ob_4");
	p_ob_1->set_parent(p_ob_4);
	
	p_ob_2 = new cl_2();
	p_ob_2->set_object_name("ob_5");
	p_ob_2->set_parent(p_ob_3);
	
	p_ob_4 = new cl_4();
	p_ob_4->set_object_name("ob_6");
